...
func (_m *FetchTokenOrchestrator) OnFetchTokenFromAuthFlow(ctx context.Context, authClient service.AuthServiceClient) *FetchTokenOrchestrator_FetchTokenFromAuthFlow {
	c := _m.On("FetchTokenFromAuthFlow", ctx, authClient)
...
// FetchTokenFromAuthFlow provides a mock function with given fields: ctx, authClient
func (_m *FetchTokenOrchestrator) FetchTokenFromAuthFlow(ctx context.Context, authClient service.AuthServiceClient) (*oauth2.Token, error) {
	ret := _m.Called(ctx, authClient)

	var r0 *oauth2.Token
	if rf, ok := ret.Get(0).(func(context.Context, service.AuthServiceClient) *oauth2.Token); ok {
		r0 = rf(ctx, authClient)
	} else {
		if ret.Get(0) != nil {
	...
	var r1 error
	if rf, ok := ret.Get(1).(func(context.Context, service.AuthServiceClient) error); ok {
		r1 = rf(ctx, authClient)
	} else {
		r1 = ret.Error(1)
	}
...
func (_m *FetchTokenOrchestrator) OnFetchTokenFromCacheOrRefreshIt(ctx context.Context, authClient service.AuthServiceClient) *FetchTokenOrchestrator_FetchTokenFromCacheOrRefreshIt {
	c := _m.On("FetchTokenFromCacheOrRefreshIt", ctx, authClient)
...
// FetchTokenFromCacheOrRefreshIt provides a mock function with given fields: ctx, authClient
func (_m *FetchTokenOrchestrator) FetchTokenFromCacheOrRefreshIt(ctx context.Context, authClient service.AuthServiceClient) *oauth2.Token {
	ret := _m.Called(ctx, authClient)
